...
The page will ban your ip if interval or the number of requests are too high.
...
File download location can be set in the browser.

Feel free to modify, I don't read novels.
